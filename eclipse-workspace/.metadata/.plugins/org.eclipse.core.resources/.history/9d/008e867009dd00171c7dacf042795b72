...
<body>
    ...
    <div id="container">
		...
		<br />
                <center>
         <p class="p1">Order List</p>
         <hr width="13%" style="border: 1px solid darkred" />
	 <br />
	 <p class="p4">Lets you view the list of orders for all reservations.</p><br />
	  ...
	  <td align="center" bgcolor="#b76d39" width="75"><p class="three">name</p></td>
	  <td align="center" bgcolor="#b76d39" width="100"><p class="three">bread</p></td>
	  <td align="center" bgcolor="#b76d39" width="75"><p class="three">date</p></td>
	  <td align="center" bgcolor="#b76d39" width="50"><p class="three">number</p></td>
      </tr>
      <%		
         int id, ref;
         int rownum = 0;
         ...
         try {
               ...
               sql = "select * from bread_order order by ref desc, id asc ";
  	 ...
  	 while(rs.next())
	 {
      ...
      <tr>
        ...
        <td align="center"> <a href=order_read.jsp?id=<%=rs.getString("id")%>>
	    <%= rs.getString("yourname") %></td>
        <td align="center"> <%= rs.getString("bread") %></td>
