            ...
            <center>
               ...
               <div class="div1">
                  ...
                  <form method="post" action="login_form.jsp">
                     <input type="submit" value="Admin Login" class="button button2">
                  </form>
               ...
               <p class="p6">
                  <br> <br> <br> <br> <br> <br>
                  <br>How to use Mr. Bread<br> <br> 1. Choose the
                  name of the bread, <br> the date of reservation, <br>
                  and the number of the bread you want.<br> <br> 2. Choose
                  the name of the bread, <br> the date of reservation, <br>
                  and the number of the bread you want.<br> <br> 3. Press
                  the ' Cast ' button <br> to enter the information in the
                  shopping cart.<br> <br> 4. You can check the shopping <br>
                  cart information on the ' Order ' page.<br> <br> 5.
                  Visit the date of your reservation <br> and take the bread
                  you ordered. <br> <br>
               </p>
            </center>
            <br />
